class Logic {
    ...
    movementLogic(){        
        ...
        if(this.ship.selected === true && this.smallResource.mouse.presses('right') && this.smallResource.pool > 0){
    ...
    resourceCollectionLogic(){
        ...
        if(this.ship.overlapping(this.smallResource) && this.goCollect == true){
            ...
            if (this.collectingCounter < 0 || this.smallResource.pool <= 0) {
            ...
            if (this.ship.visible == false) {
                this.goldTick--
                if(this.goldTick<0){
                    if(this.smallResource.pool < this.collectRate) {
                        this.collectedAmount = this.smallResource.pool;
                        this.smallResource.pool -= this.collectedAmount;
                        this.shipBag += this.collectedAmount;
                        this.goldTick = 60;
                        this.resourceCollected = true;
                    } else {
                        this.smallResource.pool -= this.collectRate;
        ...
        this.smallResource.text = this.smallResource.pool;
