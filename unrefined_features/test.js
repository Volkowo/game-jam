...
//     console.log(storeValue, activate);
...
function draw() {
    ...
    text(currentX, 100, 100)
    text(currentY, 200, 100)
...
function nodeDepletion() {
    ...
    if (resourcePoints[2] == 0 || resourcePoints[2] < 0) {
        ...
        text(resourcePoints[2], 300, 100);
    if(mouse.pressing()){
        rect(currentX, currentY, mouseX - currentX, mouseY - currentY)
    }
}